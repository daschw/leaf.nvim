    ...
    light = {
        low = function(colors)
            return {
                ...
                fg0 = colors.leaf_dark_2,
                fg1 = colors.leaf_dark_3,
                fg2 = colors.leaf_dark_4,
                fg3 = colors.leaf_dark_5,
        ...
        medium = function(colors)
            return {
                ...
                bg2 = colors.leaf_light_5,
                bg3 = colors.leaf_light_6,
                fg0 = colors.leaf_dark_1,
                fg1 = colors.leaf_dark_2,
                fg2 = colors.leaf_dark_5,
                fg3 = colors.leaf_dark_6,
        ...
        high = function(colors)
            return {
                ...
                bg2 = colors.leaf_light_6,
                bg3 = colors.leaf_light_7,
                fg0 = colors.leaf_dark_0,
                fg1 = colors.leaf_dark_1,
                fg2 = colors.leaf_dark_6,
                fg3 = colors.leaf_dark_7,
    ...
    dark = {
        low = function(colors)
            return {
                ...
                fg0 = colors.leaf_light_2,
                fg1 = colors.leaf_light_3,
                fg2 = colors.leaf_light_4,
                fg3 = colors.leaf_light_5,
        ...
        medium = function(colors)
            return {
                ...
                bg2 = colors.leaf_dark_5,
                bg3 = colors.leaf_dark_6,
                fg0 = colors.leaf_light_1,
                fg1 = colors.leaf_light_2,
                fg2 = colors.leaf_light_5,
                fg3 = colors.leaf_light_6,
        ...
        high = function(colors)
            return {
                ...
                bg2 = colors.leaf_dark_6,
                bg3 = colors.leaf_dark_7,
                fg0 = colors.leaf_light_0,
                fg1 = colors.leaf_light_1,
                fg2 = colors.leaf_light_6,
                fg3 = colors.leaf_light_7,
