    ...
    light = {
        low = function(colors)
            return {
                ...
                bg_dimmest = colors.light_dimmest,
                fg_normal = colors.dark,
                fg_dim = colors.dark_dim,
                fg_dimmer = colors.dark_dimmer,
                fg_dimmest = colors.dark_dimmest,
                fg_comment = colors.light_comment,
        ...
        medium = function(colors)
            return {
                ...
                bg_dimmest = colors.light_dimmer,
                fg_normal = colors.darker,
                fg_dim = colors.dark_dim,
                fg_dimmer = colors.dark_dimmer,
                fg_dimmest = colors.dark_dimmest,
                fg_comment = colors.lighter_comment,
        ...
        high = function(colors)
            return {
                ...
                bg_dim = colors.lighter,
                bg_dimmer = colors.light,
                bg_dimmest = colors.light_dim,
                fg_normal = colors.darkest,
                fg_dim = colors.dark_dim,
                fg_dimmer = colors.dark_dimmer,
                fg_dimmest = colors.dark_dimmest,
                fg_comment = colors.lightest_comment,
                fg_colored_bg = colors.lightest,
                red_soft = colors.red_darker,
                red_hard = colors.red_darkest,
                green_soft = colors.green_darker,
                green_hard = colors.green_darkest,
                yellow_soft = colors.yellow_darker,
                yellow_hard = colors.yellow_darkest,
                blue_soft = colors.blue_darker,
                blue_hard = colors.blue_darkest,
                purple_soft = colors.purple_darker,
                purple_hard = colors.purple_darkest,
                teal_soft = colors.teal_darker,
    ...
    dark = {
        low = function(colors)
            return {
                ...
                bg_dimmest = colors.dark_dimmest,
                fg_normal = colors.light,
                fg_dim = colors.light_dim,
                fg_dimmer = colors.light_dimmer,
                fg_dimmest = colors.light_dimmest,
                fg_comment = colors.dark_comment,
                fg_colored_bg = colors.light,
                red_soft = colors.red_dark,
        ...
        medium = function(colors)
            return {
                ...
                bg_dimmest = colors.dark_dimmer,
                fg_normal = colors.lighter,
                fg_dim = colors.light_dim,
                fg_dimmer = colors.light_dimmer,
                fg_dimmest = colors.light_dimmest,
                fg_comment = colors.darker_comment,
                fg_colored_bg = colors.lighter,
                red_soft = colors.red_light,
        ...
        high = function(colors)
            return {
                ...
                bg_dim = colors.darker,
                bg_dimmer = colors.dark,
                bg_dimmest = colors.dark_dim,
                fg_normal = colors.lightest,
                fg_dim = colors.light_dim,
                fg_dimmer = colors.light_dimmer,
                fg_dimmest = colors.light_dimmest,
                fg_comment = colors.darkest_comment,
                fg_colored_bg = colors.lightest,
                red_soft = colors.red_lighter,
                red_hard = colors.red_lightest,
                green_soft = colors.green_lighter,
                green_hard = colors.green_lightest,
                yellow_soft = colors.yellow_lighter,
                yellow_hard = colors.yellow_lightest,
                blue_soft = colors.blue_lighter,
                blue_hard = colors.blue_lightest,
                purple_soft = colors.purple_lighter,
                purple_hard = colors.purple_lightest,
                teal_soft = colors.teal_lighter,
