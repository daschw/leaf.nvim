...
function M.setup(colors, config)
    ...
    local hlgroups = {
        ...
        SpellCap = { style = config.underlineStyle, guisp = colors.yellow1 },
        SpellLocal = { style = config.underlineStyle, guisp = colors.yellow1 },
        SpellRare = { style = config.underlineStyle, guisp = colors.yellow1 },
        ...
        Function = { fg = colors.green1, style = config.functionStyle },
        -- statement ------------------------------------------------------------- purple --
        ...
        -- type --------------------------------------------------------------------- red --
        Type = { fg = colors.red1, style = config.typeStyle },
        StorageClass = { link = "Type" },
        Structure = { link = "Type" },
        Typedef = { link = "Type" },
        -- special ----------------------------------------------------------------- aqua --
        Special = { fg = colors.aqua1 },
        ...
        Debug = { link = "Special" },
        -- other ---------------------------------------------------------------------------
        Underlined = { fg = colors.aqua1, style = "underline" },
        Ignore = { link = "NonText" },
        ...
        -- Diagnostics
        ------------------------------------------------------------------------------------
        LspReferenceText = { fg = colors.bg0, bg = colors.yellow0 },
        ...
        NvimTreeRootFolder = { fg = colors.red1, style = "bold" },
        ...
        DashboardProjectTitle = { fg = colors.purple1, style = "bold" },
        DashboardProjectTitleIcon = { fg = colors.purple1 },
        DashboardProjectIcon = { fg = colors.purple0 },
        DashboardMruTitle = { fg = colors.yellow1, style = "bold" },
        DashboardMruTitleIcon = { fg = colors.yellow1 },
        ...
        FinderSpinner = { fg = colors.red1, bold = true },
        FinderPreviewSearch = { link = "Search" },
        DefinitionBorder = { link = "FloatBorder" },
        DefinitionArrow = { fg = colors.red1 },
        ...
        OutlineIndentEvn = { fg = colors.purple1 },
        OutlineIndentOdd = { fg = colors.yellow1 },
        OutlineFoldPrefix = { fg = colors.red1 },
        ...
        BufferVisibleMod = { fg = colors.yellow0, bg = colors.bg0 },
        ...
        BufferInactiveMod = { fg = colors.yellow0, bg = colors.bg1 },
        ...
        -- Notify
        ------------------------------------------------------------------------------------
        NotifyERRORBorder = { fg = colors.red0 },
        NotifyWARNBorder = { fg = colors.yellow0 },
        NotifyINFOBorder = { fg = colors.green0 },
        NotifyDEBUGBorder = { fg = colors.aqua0 },
        NotifyTRACEBorder = { fg = colors.purple0 },
        NotifyERRORIcon = { fg = colors.red1 },
        NotifyWARNIcon = { fg = colors.yellow1 },
        NotifyINFOIcon = { fg = colors.green1 },
        NotifyDEBUGIcon = { fg = colors.aqua1 },
        NotifyTRACEIcon = { fg = colors.purple1 },
        NotifyERRORTitle  = { fg = colors.red1 },
        NotifyWARNTitle = { fg = colors.yellow1 },
        NotifyINFOTitle = { fg = colors.green1 },
        NotifyDEBUGTitle  = { fg = colors.aqua1 },
