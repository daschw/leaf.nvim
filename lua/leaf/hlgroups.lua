...
function M.setup(colors, config)
    ...
    local hlgroups = {
        ...
        -- Notify
        ------------------------------------------------------------------------------------
        NotifyERRORBorder = { fg = colors.red_soft },
        NotifyWARNBorder = { fg = colors.yellow_soft },
        NotifyINFOBorder = { fg = colors.green_soft },
        NotifyDEBUGBorder = { fg = colors.teal_soft },
        NotifyTRACEBorder = { fg = colors.purple_soft },
        NotifyERRORIcon = { fg = colors.red_hard },
        NotifyWARNIcon = { fg = colors.yellow_hard },
        NotifyINFOIcon = { fg = colors.green_hard },
        NotifyDEBUGIcon = { fg = colors.teal_hard },
        NotifyTRACEIcon = { fg = colors.purple_hard },
        NotifyERRORTitle  = { fg = colors.red_hard },
        NotifyWARNTitle = { fg = colors.yellow_hard },
        NotifyINFOTitle = { fg = colors.green_hard },
        NotifyDEBUGTitle  = { fg = colors.teal_hard },
        NotifyTRACETitle  = { fg = colors.purple_hard },
