local leaf_colors = {
    ...
    -- orange
    orange0 = "#D2846D", -- (210, 132, 109)
    orange1 = "#C87D68", -- (200, 125, 104)
    orange2 = "#BD7663", -- (189, 118, 99)
    orange3 = "#9E6253", -- (158, 98, 83)
    orange4 = "#935C4E", -- (147, 92, 78)
    orange5 = "#895549", -- (137, 85, 73)
    -- yellow
    ...
    -- teal
    teal0 = "#609B8C", -- (96, 155, 140)
    teal1 = "#5A9284", -- (90, 146, 132)
    teal2 = "#54897C", -- (84, 137, 124)
    teal3 = "#436E64", -- (67, 110, 100)
    teal4 = "#3D655B", -- (61, 101, 91)
    teal5 = "#375C53", -- (55, 92, 83)
    --aqua
    ...
    -- brown
    brown0 = "#9A716F", -- (154, 113, 111)
    brown1 = "#926B6A", -- (146, 107, 106)
    brown2 = "#8A6564", -- (138, 101, 100)
    brown3 = "#725252", -- (114, 82, 82)
    brown4 = "#6A4C4D", -- (106, 76, 77)
    brown5 = "#624647", -- (98, 70, 71)
}
